  ...
  return (
    <Container>
      ...
      <ContentBlock
        direction="right"
        title={"News"}
        content={"nafankfd students from around the world, working together at the University of Cambridge to tackle critical real-world challenges using cutting-edge technologies in NLP and AI."}
        button={[]}
