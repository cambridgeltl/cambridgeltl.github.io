  ...
  return (
    <Container>
      ...
      <ContentBlock
        direction="right"
        title={"Research"}
        content={"The Language Technology Lab is engaged in several ongoing projects that aim to advance the field of natural language processing (NLP) and artificial intelligence. Our research focuses on a range of critical issues, including language understanding, machine translation, and computational semantics. These projects are driven by a diverse team of researchers and students collaborating to explore new approaches and push the boundaries of what NLP technologies can achieve. By leveraging state-of-the-art techniques, we strive to address complex challenges in both academic and real-world contexts, contributing to the broader AI research community.
